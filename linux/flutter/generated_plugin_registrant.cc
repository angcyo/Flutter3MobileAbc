...
void fl_register_plugins(FlPluginRegistry* registry) {
  ...
  g_autoptr(FlPluginRegistrar) lp_plugin_registrar =
      fl_plugin_registry_get_registrar_for_plugin(registry, "LpPlugin");
  lp_plugin_register_with_registrar(lp_plugin_registrar);
