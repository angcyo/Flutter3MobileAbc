...
class MarkdownAbc extends StatefulWidget {
  const MarkdownAbc({super.key});

  @override
  State<MarkdownAbc> createState() => _MarkdownAbcState();
}

class _MarkdownAbcState extends State<MarkdownAbc> with BaseAbcStateMixin {
  final markdown1 = '''
...
继续你的创作。
 ...
 [4]: http://adrai.github.io/flowchart.js/VPN
